...
let fullName: string = "Dave the MAgical Cheese Wizard";
let yearOfBirth:  number = 1734;
let hobby: string = "Transmuting objects to cheese";
let funFact: string = "I like cheese";
let image: string = "https://res.cloudinary.com/petrescue/image/upload/b_auto:predominant,f_auto,c_pad,h_638,w_638/v1700345060/fgjl4izzjhadoerhguwn.jpg";
