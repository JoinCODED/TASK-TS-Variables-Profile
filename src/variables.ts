...
let fullName: string = "Hasan Alwayel";
let yearOfBirth: number = 1995;
let hobby: string = "snacking";
let funFact: string = "costy hobby";
let image: string =
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ3QFyDo0BaIlhYUGsyxTNlkUwQYWZJ5Ye3nw&s";
